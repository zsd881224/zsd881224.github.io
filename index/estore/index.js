(function () {
    ...
    var choosePostCards = $('#J_ChoosePostCards');
    choosePostCards.attr('coords', [x1,y1,x2,y2].join(','));
    ...
    var chooseStamps = $('#J_ChooseStamps');
    chooseStamps.attr('coords', [x1,y1,x2,y2].join(','));
